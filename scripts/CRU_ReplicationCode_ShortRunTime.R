...
#########################################################################
## R code to roughly reproduce the numerical results shown in "Feature  #
...
## Set Num_iter=500 for full reproducibility
set.seed(1)
Num_iter = 50
...
pdf(here("figures", "fig1_short_run_time.pdf"), width = 6, height = 5)
...
## Set p=1000 for full reproducibility
set.seed(1)
p = 100
...
pdf(here("figures", "fig2_short_run_time.pdf"), width = 6, height = 5)
...
write_xlsx(Table2, here("tables", "table2_short_run_time.xlsx"))
...
## Set seed and number of repetitions
## Set Num_iter=100 for full reproducibility
set.seed(1)
Num_iter = 10

## Set number of features and observations
## Set p=10000 for full reproducibility
p = 500
n = 3000 
...
write_xlsx(Table3, here("tables", "table3_short_run_time.xlsx"))
...
write_xlsx(Table4, here("tables", "table4_short_run_time.xlsx"))
...
write_xlsx(Table5, here("tables", "table5_short_run_time.xlsx"))


#########################################
## Code for Table 6 in Section 4.1     ##
## Runtime: about 47 minutes           ##
#########################################
...
## Set number of features and observations
## Set p=5000 for full reproducibility
p = 1000
n = 2980 
...
## Initialization
## Set K=50 for full reproducibility
K = 25 
Num_noise = 20 
q = 8 
MM = c(50,100) 
...
write_xlsx(Table6, here("tables", "table6_short_run_time.xlsx"))
...
write_xlsx(Table7, here("tables", "table7_short_run_time.xlsx"))
