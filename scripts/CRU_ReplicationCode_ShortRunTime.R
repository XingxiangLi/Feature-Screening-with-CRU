...
#################################################################################################################
# The recovery of full numerical studies needs over 400 hours. By reducing the number of iterations "Num_iter"  #
# and the number of features "p", this modified script can produce the similar numerical results for testing    #
# purposes with much shorter running time.                                                                      #
#################################################################################################################
...
## Figure 1 is constructed based on Num_iter=500 repetitions.
## The tester can set Num_iter=10 for testing purpose.
...
## Plotting Figure 1
figure1_path = here("figures","Figure1_short_run_time.png")
...
## Figure 2 is constructed based on p=1000 repeated CRU estimations.
## The tester can set p=10 for testing purpose.
...
## Plotting Figure 2 ##
figure2_path = here("figures","Figure2_short_run_time.png")
...
table2_path = here("tables","table2_short_run_time.txt")
...
## Table 3 is constructed with p=10000 based on Num_iter=100 repetitions.
## Set p=100 and Num_iter=1 for testing purpose.
...
table3_path = here("tables","table3_short_run_time.txt")
...
## Table 4 is constructed with p=10000 based on Num_iter=100 repetitions.
## Set p=100 and Num_iter=1 for testing purpose.
...
table4_path = here("tables","table4_short_run_time.txt")
...
## Table 5 is constructed with p=10000 based on Num_iter=100 repetitions.
## Set p=100 and Num_iter=1 for testing purpose.
...
table5_path = here("tables","table5_short_run_time.txt")
...
## Table 6 for Setup (d) is constructed with p=5000 based on Num_iter=100 repetitions.
## Set p=100 and Num_iter=1 for testing purpose.
...
## Table 6 for Setup (e) is constructed with p=5000 based on Num_iter=100 repetitions.
## Set p=100 and Num_iter=1 for testing purpose.
...
## Table 6 for Setup (e) is constructed with p=5000 and p1=1000 correlated features based on Num_iter=100 repetitions.
## Set p=100, p1=50, and Num_iter=1 for testing purpose.
...
table6_path = here("tables","table6_short_run_time.txt")
...
## Table 7 is constructed based on Num_iter=100 repetitions.
## Set Num_iter=1 for testing purpose.
...
table7_path = here("tables","table7_short_run_time.txt")
